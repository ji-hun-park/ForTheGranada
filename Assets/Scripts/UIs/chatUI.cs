...
public class chatUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            idx = 0;
            if ((UIManager.Instance.UIList[1] != null && UIManager.Instance.UIList[1].gameObject.activeSelf == false) || !GameManager.Instance.is_running) Time.timeScale = 1;
